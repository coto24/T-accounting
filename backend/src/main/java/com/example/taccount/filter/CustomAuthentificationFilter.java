package com.example.taccount.filter;
...
public class CustomAuthentificationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public CustomAuthentificationFilter(AuthenticationManager _authenticationManager){
        this.authenticationManager = _authenticationManager;
    }
    @Override
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        //de aici imi da schema cu form,il pot face in json daca vreau
